...
def send_order(amount, source, symbol, _type, price=0):
    ...
    try:
        ...
        log.error('get acct_id error.%s' % e)
        acct_id = ACCOUNT_ID
...
# 查询当前委托、历史委托
def orders_list(symbol, states, types=None, start_date=None, end_date=None, _from=None, direct=None,
                size=None):
    """
...
# 查询当前成交、历史成交
def orders_matchresults(symbol, types=None, start_date=None, end_date=None, _from=None, direct=None,
                        size=None):
    """
